...
public sealed class InventoryReservationFailedConsumer : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        consumer.Subscribe(_options.Topics.InventoryReservationFailed);
        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            try
            {
                ...
                var ev = new InventoryReservationFailedIntegrationEvent(envelope.EventId, envelope.Payload.OrderId, envelope.Payload.Reason ?? "Unknown");
            ...
            {
                _logger.LogError(exception, "Failed to consume topic {Topic}", _options.Topics.InventoryReservationFailed);
